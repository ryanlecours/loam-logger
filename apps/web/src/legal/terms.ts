...
Loam Logger is designed to help cyclists track ride data, component usage, and **estimated** maintenance intervals for bicycles and bicycle components. The Service is intended solely as an **informational and organizational tool** to assist users in planning maintenance.
...
All information provided by the Service—including but not limited to maintenance intervals, remaining hours, wear estimates, alerts, warnings, notifications, or recommendations—is:
...
Cycling, including mountain biking, gravel riding, road cycling, and e-biking, is inherently dangerous and involves risk of serious injury, death, or property damage.
...
## 6. Explicit Disclaimer Regarding Component Failure
...
You agree to defend, indemnify, and hold harmless Loam Logger and its affiliates from and against any claims, damages, losses, liabilities, costs, and expenses (including attorneys’ fees) arising out of or related to:
...
The Service may integrate with third-party platforms (e.g., fitness tracking services).
...
We reserve the right to modify, suspend, or discontinue the Service or any feature at any time, with or without notice.

---

## 11. Termination

We may terminate or suspend your access to the Service at our discretion, without liability, for any reason, including violation of these Terms.
...
## 13. Mandatory Arbitration and Waiver of Class Actions
...
The arbitration shall be administered by the **American Arbitration Association (AAA)** and conducted under the **AAA Consumer Arbitration Rules**, which are available from the AAA.

### Location and Format

Arbitration shall be conducted:

- Remotely (via video or telephone), **or**
- In the user’s state of residence, if required by applicable law
...
These Terms constitute the entire agreement between you and Loam Logger regarding the Service and supersede all prior agreements or understandings.
