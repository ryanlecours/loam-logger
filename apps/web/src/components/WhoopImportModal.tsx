...
// Generate year options: YTD + 5 previous years
const YEAR_OPTIONS = [
  ...
  const handleTriggerImport = async () => {
    ...
    try {
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/api/whoop/backfill/fetch?year=${year}`,
        {
          credentials: 'include',
          headers: getAuthHeaders(),
        }
      ...
      setSuccessMessage(data.message || `Successfully imported rides from WHOOP.`);
      setImportStats({
        ...
        <div className="space-y-6">
          <div>
            <p className="text-sm text-muted mb-4">
              Import your historical WHOOP cycling workouts by year.
      ...
      {step === 'processing' && (
        <div className="space-y-6">
          <div className="flex flex-col items-center justify-center py-8">
            ...
            <p className="text-muted">Importing workouts from WHOOP...</p><br/>
