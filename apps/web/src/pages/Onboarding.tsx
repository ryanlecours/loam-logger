              ...
              <div className="space-y-2">
                <div className="flex justify-center mb-4">
                  <div className="w-16 h-16 rounded-full bg-green-500/20 flex items-center justify-center">
                    <FaCheck class="text-2xl text-green-400" />
                  </div>
                </div>
              ...
              <div className="grid gap-3 max-w-md mx-auto text-left">
                ...
                <div className="w-full rounded-lg border-2 border-app overflow-hidden">
                  ...
                  >
                    ...
                    {showServicePrefs ? (
                      <FaChevronUp class="w-4 h-4 text-muted shrink-0" />
                    ) : (
                      <FaChevronDown class="w-4 h-4 text-muted shrink-0" />
                    )}
                  </button>
