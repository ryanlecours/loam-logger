                        ...
                        <div className="space-y-6">
                            ...
                            <div className="max-h-[70vh] overflow-y-auto space-y-6 pr-4">
                                ...
                                <section>
                                    ...
                                    <p className="body text-muted">
                                        PostHog acts as our data processor under a data-processing agreement. They do not sell your data. For details on their practices, see <a className="text-mint hover:text-sage transition-colors underline" href="https://posthog.com/privacy" target="_blank" rel="noopener noreferrer">PostHog's privacy policy</a>. To opt out of PostHog analytics on your account, contact us at the address in Section 12.
                                    </p>
                                </section>
